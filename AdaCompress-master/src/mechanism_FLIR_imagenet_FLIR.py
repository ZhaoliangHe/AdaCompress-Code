    ...
    def agent_upload(self, image_path):
        ...
        if self.STATUS == "INFERENCE":
            ...
            if len(self.agent_memory['recent_accuracy']) > self.recent_zone and recent_acc < self.acc_threshold:
                ...
                if (self.flag == 'FLIR' and self.step_count > 2000) or (
                        self.flag == 'imagenet' and self.step_count > 5000):
                    print("yes")
...
if __name__ == '__main__':
    ...
    running_agent = RunningAgent(  # dqn_path='evaluation_results/agent_DQN_train_baidu_DNIM.h5',
        ...
        dqn_path='evaluation_results/baidu_2k_FLIR.h5',
        banchmark_q=75,
        cloud_backend=api,
    )
    ...
    test_image_paths = FLIR2 + imagenet_paths + imagenet_paths[:1000] + FLIR1
