    ...
    def agent_upload(self, image_path):
        ...
        if self.STATUS == "INFERENCE":
            ...
            if len(self.agent_memory['recent_accuracy']) > self.recent_zone and recent_acc < self.acc_threshold:
                ...
                if (self.flag == 'DNIM' and self.step_count > 720) or (self.flag == 'imagenet' and self.step_count > 2720):
                    print("yes")
                    if (self.load_model == 1 and self.step_count > 2720):
                        ...
                        self.agent_memory = defaultdict(list)
                        self.agent.model = load_model("evaluation_results/agent_DQN_baidu_all_DNIM.h5")
                        self.agent.curr_exploration_rate = 0
                        self.flag = 'DNIM_load'
                        # self.load_model = 1
                    else:
            ...
            if self.step_count > 1998:
                self.agent.model.save("evaluation_results/baidu_2k_imagenet.h5")
...
if __name__ == '__main__':
    ...
    test_image_paths = FLIR[:2000] #+ imagenet_paths + subset # + subset[:300]
    ...
    for idx, path in enumerate(test_image_paths):
        ...
        if idx % 10 == 0:
            ...
            rm.save(running_agent.running_log,
                    ...
                    name='mechanism_train_2k_imagenet',
                    topic="AgentRetrain",
