...
class Baidu(object):
    def __init__(self,
                 # AK='gVdv****************NWA',
                 AK='j1c3a6qqMRRbpRaaHd9Xmtsk',
                 # SK='OYa*********************HKc8'):
                 SK='TNfAXOPmMGTc9LOMgQzi9SUh9i6wjBcq'):
        self.api_name = "baidu"
        self.ak = AK
        self.sk = SK
...
class FacePP(Baidu):
    ...
    def __init__(self, AK='djWeYs7RNCq1b2T269HM-CzjPAE0jO-M', SK='6_zqlEcUCz-TulOYMGVsWBT_34RLq2Pt'):
...
class AmazonRekognition(Baidu):
    def __init__(self):
        self.s3 = boto3.client('s3',
                               ...
                               aws_access_key_id='AKIA6HE4VAVRVHTHR5PW',
                               aws_secret_access_key='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')
        ...
        self.bucket_name = 'fastinference-images-korea1'
