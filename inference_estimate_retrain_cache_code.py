...
#     ref_cache = pickle.load(f)
with open('evaluation_results/baidu_imagenet_model_inference_DNIM.defaultdict', 'rb') as f:
      ref_cache = pickle.load(f)
...
if __name__ == '__main__':
    ...
    for idx, path in enumerate(test_image_paths):
        ...
        if idx % 5 == 0:
            ...
            #     pickle.dump(ref_cache, f)
            with open('evaluation_results/baidu_imagenet_model_inference_DNIM_code.defaultdict', 'wb') as f:
                pickle.dump(ref_cache, f)
